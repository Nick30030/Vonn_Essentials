...
const initialPaypalOptions = {
  ...
  currency: "CAD",
  intent: "capture",
  // Disable vault/storage features that trigger third-party cookie tracking prevention
  vault: false,
  // Suppress SDK locale-cookie by explicitly setting it
  locale: "en_CA",
  // Limit loaded components to only what we use (reduces script surface area)
  components: "buttons",
  // Disable funding sources that require third-party storage
  disableFunding: "credit,paylater,venmo,sepa,bancontact,eps,giropay,ideal,mybank,p24,sofort",
};
